...
import fr.leod1.Mailleur.NMSUtils.DummyEntityPlayer;
import fr.leod1.Mailleur.NMSUtils.DummyPlayerConnection;
import fr.leod1.Mailleur.NMSUtils.ServerConnectionChannel;
import fr.leod1.Mailleur.Utils.ProfileLoader;
...
public class Bot {
	...
	public void spawn(Location loc) {
        ...
        InetSocketAddress address = (InetSocketAddress) ((CraftPlayer) spawner).getHandle().playerConnection.networkManager.channel.localAddress();
